#!/bin/bash
. /home/deepak_kumar214e17/mysql_gc/agent/script/agentic_config.param
# --- Configuration ---
#PROJECT_ID="cog01k76j1fr1385r4k0300aq7hxg" # GCP project containing the Cloud SQL instance
#REGION="us-central1" # Region of the Cloud SQL instance
#CLUSTER_ID="aia-alloydb"
#INSTANCE_NAME="cloudsql-mysql-gc-instance" # Cloud SQL MySQL instance connection name
#INSTANCE_NAME="cloudsql-postgres-instance"
#HOST="127.0.0.1" # Proxy binds locally; MySQL client connects to localhost

# Dynamically pick a free TCP port in the ephemeral range to avoid collisions.
...
#SQL_FILE="agentic_mysql_create_table.sql" # DDL file that creates tables etc.
#BUCKET="gs://alloydb-usecase/uploads"
#DB_USER="root" # Admin (or privileged) MySQL user
#PASSWORD="Mysql@dev1" # Admin password

# --- New User Details ---
#NEW_USER="app_user"
#NEW_PASSWORD="Mysql@dev1" # Choose a strong, secure password for the new user
