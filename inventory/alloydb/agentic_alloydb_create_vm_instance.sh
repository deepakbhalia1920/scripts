...
TGT_PATH="/home/deepak_kumar214e17/"
SRC_PATH="/home/deepak_kumar214e17/alloydb_gc/agentic/script/"
...
#gcloud compute ssh chk-test --zone=us-central1-b --command="bash /home/deepak_kumar214e17/create_ddl.sh"
##
if [ $? -eq 0 ]; then
