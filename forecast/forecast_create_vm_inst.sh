...
SCRIPT_FILES=("forecast_config.param" "forecast_create_ddl.sh" "forecast_create_table.sql")
...
gcloud compute ssh "${INSTANCE_NAME}" --zone="${ZONE_NAME}" --command="bash ${TGT_PATH}forecast_create_ddl.sh \"${ALLOYDB_IP}\""
