...
SCRIPT_FILES=("forecast_config.param" "forecast_presql_wrapper.sh" "forecast_create_presql.sql")
#USERNAME="deepak_kumar214e17"
TGT_PATH="/home/${USERNAME}/"
SRC_PATH="/home/${USERNAME}/alloydb_gc/forecast/script/"
...
gcloud compute ssh "${INSTANCE_NAME}" --zone="${ZONE_NAME}" --command="bash ${TGT_PATH}forecast_presql_wrapper.sh \"${ALLOYDB_IP}\""
