...
ALTER TABLE alloydb_demo.fashion_products_chk2312 
...
UPDATE alloydb_demo.fashion_products_chk2312
...
CREATE INDEX ON alloydb_demo.fashion_products_chk2312 USING gin(to_tsvector('english', combined_description));
-- SCANN INDEX FOR VECTOR SEARCH
CREATE INDEX my_scann_index ON alloydb_demo.fashion_products_chk2312
...
SELECT alloydb_ai_nl.g_manage_configuration( 
  ...
  table_views_in => '{alloydb_demo.fashion_products_chk2312}' 
); 
