...
ALTER TABLE alloydb_demo.fashion_products 
...
UPDATE alloydb_demo.fashion_products
...
CREATE INDEX ON alloydb_demo.fashion_products USING gin(to_tsvector('english', combined_description));
-- SCANN INDEX FOR VECTOR SEARCH
CREATE INDEX my_scann_index ON alloydb_demo.fashion_products
