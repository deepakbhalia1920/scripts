...
#SCOPES="https://www.googleapis.com/auth/cloud-platform" # Broad scope (consider least-privilege SA)
# --------------------------- Account / Project --------------------------------
...
# ----------------------------- AlloyDB ----------------------------------------
# If using Private IP Connector / VPC peering, AlloyDB host is a private address.
# ALLOYDB_HOST can be uncommented when you want runtime connectivity testing.
...
SCRIPT_FILES=("fashion_config.param" "ecomm_fashion_wrapper_ddl.sh" "ecomm_fashion_ddl.sql")
#USERNAME="deepak_kumar214e17"
TGT_PATH="/home/${USERNAME}/"
SRC_PATH="/home/${USERNAME}/alloydb_gc/ecomm/script/"
...
gcloud compute ssh "${INSTANCE_NAME}" --zone="${ZONE_NAME}" --command="bash ${TGT_PATH}ecomm_fashion_wrapper_ddl.sh \"${ALLOYDB_IP}\""
