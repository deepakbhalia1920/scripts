...
#INSTANCE_NAME="cloudsql-postgres-instance-0112"  # Cloud SQL instance
#REGION="us-central1" # Instance region
#DB_NAME="postgres" # Target database       
#DB_USER="postgres" # Database user
# Bucket where CSV is stored
#BUCKET_NAME_ROOT="gs://alloydb-gc-usecase-newsetup/"  # Used for IAM grant
...
#echo "Ecomm data loaded successfully"